...
2. **Standard Mode** (recommended):
   ...
   aipartnerupflow run flow --tasks '[{"id": "task1", "name": "Task 1", "schemas": {"method": "executor1"}, "input_data": {"key": "value"}}]'
...
aipartnerupflow run flow --tasks '[
  {"id": "task1", "name": "Task 1", "schemas": {"method": "executor1"}, "input_data": {"key": "value"}},
  {"id": "task2", "name": "Task 2", "schemas": {"method": "executor2"}, "input_data": {"key": "value2"}}
]'
