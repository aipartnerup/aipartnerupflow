...
aipartnerupflow run flow --tasks '[{"id": "task1", "name": "Task 1", "schemas": {"method": "executor_id"}, "input_data": {"data": "test"}}]'
...
aipartnerupflow run flow \
  --tasks '[{"id": "task1", "name": "Task 1", "schemas": {"method": "executor_id"}, "input_data": {"data": "test"}}]' \
  --background \
  --watch
...
aipartnerupflow run flow \
  --tasks '[
    {"id": "task1", "name": "Task 1", "schemas": {"method": "executor1"}, "input_data": {}},
    {"id": "task2", "name": "Task 2", "schemas": {"method": "executor2"}, "input_data": {}},
    {"id": "task3", "name": "Task 3", "schemas": {"method": "executor3"}, "input_data": {}}
  ]' \
  --background
...
aipartnerupflow run flow --tasks '[{"id": "task1", "name": "Task 1", "schemas": {"method": "executor_id"}, "input_data": {"key": "value"}}]'

# Execute task tree (parent-child relationships)
aipartnerupflow run flow --tasks '[
  {"id": "root", "name": "Root Task", "schemas": {"method": "executor1"}, "input_data": {}},
  {"id": "child1", "name": "Child 1", "parent_id": "root", "schemas": {"method": "executor2"}, "input_data": {}}
]'
