...
class TaskModel(Base):
    ...
    # === Task Data ===
    input_data = Column(JSON, nullable=True)  # Input data for the task
    ...
    schemas = Column(JSON, nullable=True)  # Task schemas (execution config, input_schema, output_schema, etc.)
